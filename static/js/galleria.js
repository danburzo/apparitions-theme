...
Galleria.prototype.next = function() {
	this.select((this.current && this.current.nextElementSibling) || this.getFirstItemElement(this.el));
	this.animate();
}

Galleria.prototype.prev = function() {
	this.select((this.current && this.current.previousElementSibling) || this.getLastItemElement(this.el));
	this.animate();
}
